/* Wazp3D Beta 55 : Alain THELLIER - Paris - FRANCE - (November 2006 to 2012) 	*/
...
/*==================================================================================*/
#define DRIVERNAME "Wazp3D - Alain Thellier - Paris France 2013 - Beta 55"
#define PREFSNAME  "Wazp3D-Prefs Beta 55 Alain Thellier 2013"
...
void *pt;
	...
	pt=AllocVecTags(size, AVT_Type, MEMF_SHARED, AVT_ClearWithValue, 0, TAG_DONE);
	if(pt==NULL)
		return(AllocVecTags(size, AVT_Type, MEMF_PRIVATE|MEMF_SHARED|MEMF_EXECUTABLE, AVT_ClearWithValue, 0, TAG_DONE));
	else
		return(pt);
}
/*==================================================================================*/
